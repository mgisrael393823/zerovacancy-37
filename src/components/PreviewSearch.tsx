  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8">
      <div className="mx-auto">
        <div className="rounded-xl overflow-hidden shadow-lg border border-gray-100 bg-white p-4 sm:p-8">
          {/* Combined all sections into one div with consistent padding */}
