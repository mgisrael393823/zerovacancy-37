...
// Define creators array outside the component
const creators = [
  {
    name: "Emily Johnson",
          ...
          <div className="p-4 sm:p-8 w-full">
            <div className="w-full bg-white space-y-6 sm:space-y-8">
              ...
              <div className="text-center">
                <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-3 sm:mb-4 font-heading">Discover Featured Creators</h2>
