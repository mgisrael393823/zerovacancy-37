  ...
  return (
    ...
    >
      ...
      >
        ...
        <Card3D rotate={rotate} translate={translate} scale={scale}>
          {children}
        </Card3D>
      </div>
    </div>
      ...
      <div className="container px-4 md:px-6">
        <div className="text-center space-y-3 mb-8">
          ...
          <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed mx-auto max-w-[700px]">
            Search through our network of professional photographers and videographers to capture your property at its best.
          </p>
        </div>
...
function SearchSection() {
  return (
    <div
      ...
      className="w-full h-full mx-auto rounded-xl shadow-lg overflow-hidden px-4 pt-4 pb-[1px] font-sans"
    >
